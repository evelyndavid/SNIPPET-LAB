...
//     return (
//         <Navbar expand="lg" style={{ background: '#C5C6C7', padding: '15px 20px' ,zIndex: 1030}}>
//             <Container>
...
//                     <Nav>
//                         <Nav.Link href="#" style={{ color: '#000', fontWeight: 'bold' }}>Home</Nav.Link>
//                         <Nav.Link onClick={() => navigate('/SignUp')} style={{ color: '#000', fontWeight: 'bold' }}>Sign Up</Nav.Link>
//                         <Nav.Link onClick={() => navigate('/Login')} style={{ color: '#000', fontWeight: 'bold' }} >Login</Nav.Link>
//                     </Nav>
//                 </Navbar.Collapse>
//             </Container>
//         </Navbar>
